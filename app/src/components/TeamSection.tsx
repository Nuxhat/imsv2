  ...
  const teamMembers = [
    {
      id: 1,
      name: "Raveed Riaz ",
      role: "Director of Retail Transformation",
      image: "/team-2.jpg",
    },
    {
      id: 2,
  ...
  return (
    <section className="bg-white py-24 md:py-32">
      <div className="container mx-auto px-6 lg:px-12 max-w-[1400px]">
        ...
        {/* TEAM GRID - CHANGED TO FLEXBOX FOR CENTERING */}
        <div className="flex flex-col sm:flex-row justify-center items-center gap-8 w-full">
          {teamMembers.map((member, index) => (
            <ScrollReveal key={member.id} delay={200 + (index * 150)}>
              ...
              {/* THE FIX: Added 'shrink-0' and 'sm:w-[320px]' so Flexbox doesn't collapse them to 0 pixels! */}
              <div className="relative w-full max-w-[320px] sm:w-[320px] shrink-0 aspect-[3/4] rounded-[24px] overflow-hidden group cursor-pointer shadow-lg">
