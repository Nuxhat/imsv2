...
export default function DataHANAReportingPage() {
  return (
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-14 items-start">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              ...
              {[
                ...
                },
                {
                  ...
                  desc: "Real-time dashboards for monitoring KPIs and performance."
                },
                {
                  title: "Financial Reports",
                  desc: "Accurate financial insights for better decision-making."
                },
                {
                  title: "Data Visualization",
                  desc: "Turn complex data into simple visual insights."
                },
                {
                  title: "BI Analytics",
                  desc: "Advanced business intelligence for strategic planning."
                },
                {
            ...
            <div className="relative">
              ...
              <div
                ...
                style={{ backgroundImage: "url('/sap-work-2.jpg')" }}
              />
