...
export default function CustomAddOnDevPage() {
  return (
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              ...
              {[
                ...
                },
                {
                  ...
                  desc: "Automate repetitive tasks and reduce manual operations.",
                },
                {
                ...
                },
                {
                  ...
                  desc: "Improve efficiency through smart system enhancements.",
                },
                {
                  title: "Scalable Architecture",
                  desc: "Future-ready development built for enterprise growth.",
                },
              ].map((item, i) => (
                <div
                  key={i}
